...
export default function CalendarView({ calendar, userId }) {
  ...
  const [formPresetDate, setFormPresetDate] = useState(null);
  ...
  function openNewEventForDay(day) {
    const iso = toISODate(new Date(year, month, day));
    setEditingEvent(null);
    setFormPresetDate(iso);
    setShowForm(true);
    ...
    <main className="min-h-screen px-4 py-6 max-w-md mx-auto">
      <div className="flex items-center justify-between mb-1">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() => { setEditingEvent(null); setFormPresetDate(null); setShowForm(true); }}
      ...
      {dayEventsList && (
        <DayEventsModal
          ...
          onAddNew={() => openNewEventForDay(dayEventsList.day)}
      ...
      {selectedEvent && (
        <EventPanel
          ...
          onEdit={() => { setEditingEvent(selectedEvent); setFormPresetDate(null); setShowForm(true); setSelectedEvent(null); }}
